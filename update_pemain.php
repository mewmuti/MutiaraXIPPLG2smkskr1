...
$data = mysqli_fetch_array($queryAmbilData);
    ...
    if(isset($_POST['update'])){
        ...
        $nomor_punggung = $_POST['nomor_punggung'];
            ...
            $query = mysqli_query($con,"UPDATE pemain SET nama='$nama', asal_negara='$asal_negara', posisi='$posisi', nomor_punggung='$no_punggung' WHERE id_pemain='$id_pemain'");
            if($query){
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="mb-3">
            <label for="nomor_punggung" class="form-label">No Punggung</label>
            <input type="text" class="form-control" id="exampleInputPassword1" name="nomor_punggung" value="<?php echo $data['nomor_punggung']; ?>">
        </div>
